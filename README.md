...
Install one skill instead of all of them:
...
Works with Claude Code, the Claude apps, Cursor, Codex, OpenCode and 70+ other agents.
...
Встановити один скіл замість усіх:
...
Працює з Claude Code, застосунками Claude, Cursor, Codex, OpenCode і ще 70+ агентами.
