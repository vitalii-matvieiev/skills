...
| **[hermes-setup](hermes-setup/)** | Takes you from nothing to your own AI agent living on a server: where it should run, what it costs, what it is allowed to touch, and how to fix it when it breaks. Ten stages, built around never having to use the terminal. |
...
| **[hermes-setup](hermes-setup/)** | Веде від нуля до власного AI-агента, який живе на сервері: де йому працювати, скільки це коштує, до чого його можна пускати і що робити, коли зламається. Десять етапів, побудованих так, щоб не довелося користуватися терміналом. |
